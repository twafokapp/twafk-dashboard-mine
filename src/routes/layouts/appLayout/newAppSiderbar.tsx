...
export function NewAppSidebar() {
  ...
  return (
    ...
    <div className='absolute z-5 '>
      <Sidebar side={i18n.language === 'ar' ? 'right ' : 'left '} className='right-26 top-16 shadow-main'>
        <SidebarGroup>
              ...
              return (
                <div className=' '>
                  <section className='flex flex-col justify-center items-center gap-4  '>
                    <div className='bg-primary-light p-[14px] rounded-xl w-14 hover:bg-primary hover:*:stroke-white hover:cursor-pointer'>
